...
from app.config import APP_NAME, ROOT_DIR


def _startup_command() -> str:
    python = Path(sys.executable).resolve()
    main = ROOT_DIR / "app" / "main.py"
    # pythonw preferred if available for no console
...
def set_startup(enabled: bool) -> bool:
    ...
    try:
        ...
        launcher = str((ROOT_DIR / "run_app.vbs").resolve())
        workdir = str(ROOT_DIR.resolve())
